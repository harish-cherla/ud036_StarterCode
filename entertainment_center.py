...
spiderman= media.Movie("Spider Man",
                   "Check out the new Spider-Man: Homecoming trailer starring Robert Downey Jr., Tom Holland, and Marisa Tomei! Be the first to watch.",
                   "https://i.ytimg.com/vi/YxKbJrjR9qM/hqdefault.jpg",
                   "YxKbJrjR9qM")

babyBos= media.Movie("Baby Bos",
                   "Thor must face the Hulk in a gladiator match and save his people from the ruthless Hela.",
                   "https://i.ytimg.com/vi/Zh1rw_rKRw0/hqdefault.jpg",
                   "Cimp-eTe3MU")

kungfu= media.Movie("Kung Fu Ninja",
